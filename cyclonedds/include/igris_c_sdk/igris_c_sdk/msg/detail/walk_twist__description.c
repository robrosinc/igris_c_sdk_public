  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x08, 0xea, 0xe0, 0xfc, 0x5c, 0xf9, 0xfd, 0x7d,
      0xda, 0xe6, 0xc3, 0x81, 0x8e, 0x9f, 0x7f, 0x1e,
      0x30, 0x40, 0xae, 0x05, 0x29, 0x67, 0x6c, 0x7f,
      0x74, 0xcc, 0x06, 0xe0, 0xa0, 0x84, 0x26, 0x6c,
    }};
  return &hash;
}
...
static char igris_c_sdk__msg__WalkTwist__TYPE_NAME[] = "igris_c_sdk/msg/WalkTwist";
...
static char igris_c_sdk__msg__WalkTwist__FIELD_NAME__header[] = "header";
static char igris_c_sdk__msg__WalkTwist__FIELD_NAME__twist[] = "twist";

static rosidl_runtime_c__type_description__Field igris_c_sdk__msg__WalkTwist__FIELDS[] = {
  {
    {igris_c_sdk__msg__WalkTwist__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {igris_c_sdk__msg__WalkTwist__FIELD_NAME__twist, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription igris_c_sdk__msg__WalkTwist__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {geometry_msgs__msg__Twist__TYPE_NAME, 23, 23},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {igris_c_sdk__msg__WalkTwist__TYPE_NAME, 25, 25},
      {igris_c_sdk__msg__WalkTwist__FIELDS, 2, 2},
    },
    {igris_c_sdk__msg__WalkTwist__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[2].fields = igris_c_sdk__msg__Header__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *igris_c_sdk__msg__WalkTwist__get_individual_type_description_source(NULL),
    ...
    sources[3] = *igris_c_sdk__msg__Header__get_individual_type_description_source(NULL);
    constructed = true;
  }
