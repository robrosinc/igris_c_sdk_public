...
#ifndef IGRIS_C_SDK__MSG__DETAIL__JOINT_STATE__TRAITS_HPP_
#define IGRIS_C_SDK__MSG__DETAIL__JOINT_STATE__TRAITS_HPP_
...
inline void to_yaml(
  const igris_c_sdk::msg::JointState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const igris_c_sdk::msg::JointState & msg)
{
  return igris_c_sdk::msg::to_yaml(msg);
}

template<>
inline const char * data_type<igris_c_sdk::msg::JointState>()
{
  return "igris_c_sdk::msg::JointState";
}

template<>
inline const char * name<igris_c_sdk::msg::JointState>()
{
  return "igris_c_sdk/msg/JointState";
}

template<>
struct has_fixed_size<igris_c_sdk::msg::JointState>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<igris_c_sdk::msg::JointState>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<igris_c_sdk::msg::JointState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // IGRIS_C_SDK__MSG__DETAIL__JOINT_STATE__TRAITS_HPP_
