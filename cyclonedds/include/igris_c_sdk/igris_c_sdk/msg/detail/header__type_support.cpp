...
{
  new (message_memory) igris_c_sdk::msg::Header(_init);
}

void Header_fini_function(void * message_memory)
{
  auto typed_message = static_cast<igris_c_sdk::msg::Header *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Header_message_member_array[4] = {
  {
    ...
    offsetof(igris_c_sdk::msg::Header, seq),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(igris_c_sdk::msg::Header, sec),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(igris_c_sdk::msg::Header, nanosec),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(igris_c_sdk::msg::Header, frame_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<igris_c_sdk::msg::Header>()
{
  return &::igris_c_sdk::msg::rosidl_typesupport_introspection_cpp::Header_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, igris_c_sdk, msg, Header)() {
  return &::igris_c_sdk::msg::rosidl_typesupport_introspection_cpp::Header_message_type_support_handle;
}
