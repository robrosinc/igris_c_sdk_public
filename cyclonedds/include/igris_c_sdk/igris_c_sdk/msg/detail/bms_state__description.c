...
static char toplevel_type_raw_source[] =
  ...
  "uint8 BMS_NOT_INITIALIZED=0   # 0b00: neither (bit0=BMS, bit1=motor)\n"
  "uint8 BMS_INITIALIZED=1       # 0b01: only BMS initialized\n"
  "uint8 MOTOR_INITIALIZED=2     # 0b10: only motor initialized\n"
  "uint8 BOTH_INITIALIZED=3      # 0b11: BMS | motor\n"
  "Header header\n"
  "uint8 body_power\n"
  "uint8 legs_power\n"
  "uint8 estop\n"
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {igris_c_sdk__msg__BmsState__TYPE_NAME, 24, 24},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 477, 477},
  };
  return &source;
}
