...
#ifndef IGRIS_C_SDK__SRV__DETAIL__MUJOCO_SIM_CMD__FUNCTIONS_H_
#define IGRIS_C_SDK__SRV__DETAIL__MUJOCO_SIM_CMD__FUNCTIONS_H_
...
/// Initialize srv/MujocoSimCmd message.
/**
 ...
 * )) before or use
 * igris_c_sdk__srv__MujocoSimCmd_Request__create()
...
/// Finalize srv/MujocoSimCmd message.
/**
...
/// Create srv/MujocoSimCmd message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * igris_c_sdk__srv__MujocoSimCmd_Request__init().
...
/// Destroy srv/MujocoSimCmd message.
/**
 * It calls
 * igris_c_sdk__srv__MujocoSimCmd_Request__fini()
...
/// Check for srv/MujocoSimCmd message equality.
/**
...
/// Copy a srv/MujocoSimCmd message.
/**
...
/// Initialize array of srv/MujocoSimCmd messages.
/**
...
/// Finalize array of srv/MujocoSimCmd messages.
/**
 * It calls
 * igris_c_sdk__srv__MujocoSimCmd_Request__fini()
...
/// Create array of srv/MujocoSimCmd messages.
/**
 * It allocates the memory for the array and calls
 * igris_c_sdk__srv__MujocoSimCmd_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MujocoSimCmd messages.
/**
 * It calls
 * igris_c_sdk__srv__MujocoSimCmd_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MujocoSimCmd message array equality.
/**
...
/// Copy an array of srv/MujocoSimCmd messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * igris_c_sdk__srv__MujocoSimCmd_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_igris_c_sdk
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * igris_c_sdk__srv__MujocoSimCmd_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_igris_c_sdk
...
/**
 * It calls
 * igris_c_sdk__srv__MujocoSimCmd_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_igris_c_sdk
...
/**
 * It allocates the memory for the array and calls
 * igris_c_sdk__srv__MujocoSimCmd_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_igris_c_sdk
...
/**
 * It calls
 * igris_c_sdk__srv__MujocoSimCmd_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * igris_c_sdk__srv__MujocoSimCmd_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_igris_c_sdk
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * igris_c_sdk__srv__MujocoSimCmd_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_igris_c_sdk
...
/**
 * It calls
 * igris_c_sdk__srv__MujocoSimCmd_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_igris_c_sdk
...
/**
 * It allocates the memory for the array and calls
 * igris_c_sdk__srv__MujocoSimCmd_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_igris_c_sdk
...
/**
 * It calls
 * igris_c_sdk__srv__MujocoSimCmd_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // IGRIS_C_SDK__SRV__DETAIL__MUJOCO_SIM_CMD__FUNCTIONS_H_
