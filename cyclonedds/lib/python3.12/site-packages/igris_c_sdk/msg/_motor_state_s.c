...
bool igris_c_sdk__msg__motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("igris_c_sdk.msg._motor_state.MotorState", full_classname_dest, 39) == 0);
  }
  igris_c_sdk__msg__MotorState * ros_message = _ros_message;
  {  // q
  ...
  {  // status_bits
    PyObject * field = PyObject_GetAttrString(_pymsg, "status_bits");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->status_bits = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * igris_c_sdk__msg__motor_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("igris_c_sdk.msg._motor_state");
  ...
  {  // status_bits
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->status_bits);
    {
      int rc = PyObject_SetAttrString(_pymessage, "status_bits", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
