...
bool igris_c_sdk__msg__header__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("igris_c_sdk.msg._header.Header", full_classname_dest, 30) == 0);
  }
  igris_c_sdk__msg__Header * ros_message = _ros_message;
  {  // seq
...
PyObject * igris_c_sdk__msg__header__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("igris_c_sdk.msg._header");
