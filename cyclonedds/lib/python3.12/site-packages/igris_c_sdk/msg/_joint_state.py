...
class JointState(metaclass=Metaclass_JointState):
    ...
    def __init__(self, **kwargs):
        ...
        self.status_bits = kwargs.get('status_bits', int())
    ...
    def status_bits(self):
        """Message field 'status_bits'."""
        return self._status_bits

    @status_bits.setter
    def status_bits(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'status_bits' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'status_bits' field must be an unsigned integer in [0, 4294967295]"
        self._status_bits = value
