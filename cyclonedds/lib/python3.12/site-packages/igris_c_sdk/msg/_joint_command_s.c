...
bool igris_c_sdk__msg__joint_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("igris_c_sdk.msg._joint_command.JointCommand", full_classname_dest, 43) == 0);
  }
  igris_c_sdk__msg__JointCommand * ros_message = _ros_message;
  {  // header
  ...
  {  // mode
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      if (!rosidl_runtime_c__int8__Sequence__init(&(ros_message->mode), size)) {
        PyErr_SetString(PyExc_RuntimeError, "unable to create int8__Sequence ros_message");
        PyBuffer_Release(&view);
        Py_DECREF(field);
        return false;
      }
      int8_t * dest = ros_message->mode.data;
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * igris_c_sdk__msg__joint_command__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of JointCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("igris_c_sdk.msg._joint_command");
  ...
  igris_c_sdk__msg__JointCommand * ros_message = (igris_c_sdk__msg__JointCommand *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
  ...
  {  // mode
    ...
    if (ros_message->mode.size > 0) {
      ...
      int8_t * src = &(ros_message->mode.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->mode.size * sizeof(int8_t));
      assert(data != NULL);
