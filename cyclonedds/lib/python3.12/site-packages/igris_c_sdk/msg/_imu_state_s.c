...
bool igris_c_sdk__msg__imu_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("igris_c_sdk.msg._imu_state.IMUState", full_classname_dest, 35) == 0);
  }
  igris_c_sdk__msg__IMUState * ros_message = _ros_message;
  {  // quaternion
...
PyObject * igris_c_sdk__msg__imu_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("igris_c_sdk.msg._imu_state");
