...
echo -e "  ./service_example <domain_id> <namespace> - Service API (menu-based)"
echo -e "  ./lowlevel_example <domain_id> <namespace> - Pub/Sub low-level control"
echo -e "  ./sdk_gui_client <domain_id> <namespace>  - Full GUI client"
echo -e "  ./hand_gui_client <domain_id> <namespace> - Hand control GUI client"
echo -e "  ./metaquest <domain_id> <namespace> [topic] - MetaQuest raw data table viewer"
echo -e "  ./sensor_configuration <domain_id> <namespace> [timeout_ms] - Sensor configuration example"
if [ -f "${BUILD_DIR}/sensor_viewer" ]; then
    echo -e "  ./sensor_viewer <domain_id> <namespace> [topics...] - Sensor data visualization"
fi
