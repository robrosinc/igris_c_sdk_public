...
Select an action:
  ...
  25. HOME
  Publishing
  26. Publish a single LowCmd (all-zero, gains=0)
   q. Quit
"""
...
_CONTROL_MODE_DISPATCH: dict[str, tuple[str, dict]] = {
    ...
    "18": ("CUSTOM_MODE_4", {"cmd_type_name": "CONTROL_MODE_CMD_CUSTOM_MODE_4"}),
    "19": ("CUSTOM_MODE_5", {"cmd_type_name": "CONTROL_MODE_CMD_CUSTOM_MODE_5"}),
    "20": ("CUSTOM_MODE_6", {"cmd_type_name": "CONTROL_MODE_CMD_CUSTOM_MODE_6"}),
    "21": ("CUSTOM_MODE_7", {"cmd_type_name": "CONTROL_MODE_CMD_CUSTOM_MODE_7"}),
    "22": ("CUSTOM_MODE_8", {"cmd_type_name": "CONTROL_MODE_CMD_CUSTOM_MODE_8"}),
    "23": ("CUSTOM_MODE_9", {"cmd_type_name": "CONTROL_MODE_CMD_CUSTOM_MODE_9"}),
    "24": ("CUSTOM_MODE_10", {"cmd_type_name": "CONTROL_MODE_CMD_CUSTOM_MODE_10"}),
    "25": (
        "MOTION_PRESET(HOME)",
